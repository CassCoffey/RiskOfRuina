...
namespace RiskOfRuinaMod.Modules.Achievements
{
    ...
    {
        public override string AchievementIdentifier { get; } = RiskOfRuinaPlugin.developerPrefix + "_ARBITER_BODY_MASTERYUNLOCKABLE_ACHIEVEMENT_ID";
        public override string UnlockableIdentifier { get; } = RiskOfRuinaPlugin.developerPrefix + "_ARBITER_BODY_MASTERYUNLOCKABLE_REWARD_ID";
        public override string AchievementNameToken { get; } = RiskOfRuinaPlugin.developerPrefix + "_ARBITER_BODY_MASTERYUNLOCKABLE_ACHIEVEMENT_NAME";
        ...
        public override Func<string> GetHowToUnlock { get; } = (() => Language.GetStringFormatted("UNLOCK_VIA_ACHIEVEMENT_FORMAT", new object[]
                            {
                                Language.GetString(RiskOfRuinaPlugin.developerPrefix + "_ARBITER_BODY_MASTERYUNLOCKABLE_ACHIEVEMENT_NAME"),
                                Language.GetString(RiskOfRuinaPlugin.developerPrefix + "_ARBITER_BODY_MASTERYUNLOCKABLE_ACHIEVEMENT_DESC")
                            }));
