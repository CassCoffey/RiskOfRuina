...
namespace RiskOfRuinaMod.Modules
{
    public static class Config
    {
        ...
        public static void ReadConfig()
        {
            ...
            moveSpeedMult = RiskOfRuinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("Red Mist :: Stats", "Move Speed Ratio"), 1f, new ConfigDescription("Alter this to change how much 1% move speed is worth in damage."));
            attackSpeedMult = RiskOfRuinaPlugin.instance.Config.Bind<float>(new ConfigDefinition("Red Mist :: Stats", "Attack Speed Ratio"), 1f, new ConfigDescription("Alter this to change how much 1% attack speed is worth in damage."));
            ...
            redMistBuffMaintain = RiskOfRuinaPlugin.instance.Config.Bind<bool>(new ConfigDefinition("Red Mist :: EGO", "Buff Maintain"), true, new ConfigDescription("Set this to false to have Red Mist's EGO stacks get cleared when EGO is lost."));
