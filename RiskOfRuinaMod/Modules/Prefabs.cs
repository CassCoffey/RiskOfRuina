...
namespace RiskOfRuinaMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = RiskOfRuinaPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = RiskOfRuinaPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = RiskOfRuinaPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = RiskOfRuinaPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        internal static GameObject CreatePrefab(string bodyName, string modelName, BodyInfo bodyInfo)
        {
            ...
            bodyComponent.sprintingSpeedMultiplier = bodyInfo.sprintSpeedMult;
            ...
            newPrefab.GetComponent<CameraTargetParams>().cameraParams = Modules.CameraParams.defaultCameraParamsRedMist;
        ...
        {
            RiskOfRuinaPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            RiskOfRuinaPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            RiskOfRuinaPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
