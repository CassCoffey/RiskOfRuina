...
namespace RiskOfRuinaMod.Modules
{
    internal static class Skills
    {
        ...
        {
            ScepterBasicAttack = Modules.Skills.CreatePrimarySkillDef(new EntityStates.SerializableEntityStateType(typeof(SkillStates.BasicStringStart)), "Body", prefix + "_REDMIST_BODY_PRIMARY_UPSTANDINGSLASH_NAME", prefix + "_REDMIST_BODY_PRIMARY_UPSTANDINGSLASH_DESCRIPTION", Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texRedMistPrimaryIcon"), false);

            Skills.skillDefs.Add(ScepterBasicAttack);

            States.AddSkill(typeof(SkillStates.ScepterChannelShockwave));
            States.AddSkill(typeof(SkillStates.ScepterCastShockwave));

            scepterShockwaveDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterSpecialIconScepter"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.ScepterChannelShockwave)),
        ...
        internal static void CreateSkillFamilies(GameObject targetPrefab)
        {
            ...
            {
                RiskOfRuinaPlugin.DestroyImmediate(obj);
            }
        ...
        {
            RedMistEGOSkillDef skillDef = ScriptableObject.CreateInstance<RedMistEGOSkillDef>();
        ...
        {
            TargettedSkillDef skillDef = ScriptableObject.CreateInstance<TargettedSkillDef>();
