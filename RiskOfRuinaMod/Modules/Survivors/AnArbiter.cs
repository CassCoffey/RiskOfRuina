...
namespace RiskOfRuinaMod.Modules.Survivors
{
    internal class AnArbiter : SurvivorBase
    {
        ...
        internal static Material arbiterMat = Modules.Assets.CreateMaterial("matArbiter", 0.8f, Color.yellow);
        ...
        internal override void InitializeCharacter()
        {
            ...
            TargetTracker tracker = this.bodyPrefab.AddComponent<Modules.Components.TargetTracker>();
            tracker.maxTrackingDistance = 40f;
        }

        internal override void InitializeUnlockables()
        {
            masterySkinUnlockableDef = Modules.Unlockables.AddUnlockable<Achievements.ArbiterMasteryAchievement>(true);
        }
        ...
        internal override void InitializeHitboxes()
        {
            ...
            Transform hitboxTransform = childLocator.FindChild("FairyHitbox");
            Modules.Prefabs.SetupHitbox(model, hitboxTransform, "Fairy");
        }
        ...
        internal override void InitializeSkills()
        {
            ...
            #region Primary
            Modules.Skills.AddPrimarySkill(bodyPrefab, Modules.Skills.CreatePrimarySkillDef(new EntityStates.SerializableEntityStateType(typeof(SkillStates.FairyCombo)), "Weapon", prefix + "_ARBITER_BODY_PRIMARY_FAIRY_NAME", prefix + "_ARBITER_BODY_PRIMARY_FAIRY_DESCRIPTION", Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterPrimaryIcon"), false));
            #endregion

            #region Secondary
            SkillDef lockSkillDef = Modules.Skills.CreateTrackerSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_ARBITER_BODY_SECONDARY_LOCK_NAME",
                skillNameToken = prefix + "_ARBITER_BODY_SECONDARY_LOCK_NAME",
                skillDescriptionToken = prefix + "_ARBITER_BODY_SECONDARY_LOCK_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterSecondaryIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Lock)),
            ...
            #region Utility
            SkillDef pillarsSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_ARBITER_BODY_UTILITY_PILLARS_NAME",
                skillNameToken = prefix + "_ARBITER_BODY_UTILITY_PILLARS_NAME",
                skillDescriptionToken = prefix + "_ARBITER_BODY_UTILITY_PILLARS_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterUtilityIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.ChannelPillar)),
            ...
            SkillDef pillarsSpearSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                skillNameToken = prefix + "_ARBITER_BODY_UTILITY_PILLARSSPEAR_NAME",
                skillDescriptionToken = prefix + "_ARBITER_BODY_UTILITY_PILLARSSPEAR_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterUtilityTwoIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.ChargePillarSpear)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 1,
            ...
            #region Special
            SkillDef shockwaveSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_ARBITER_BODY_SPECIAL_SHOCKWAVE_NAME",
                skillNameToken = prefix + "_ARBITER_BODY_SPECIAL_SHOCKWAVE_NAME",
                skillDescriptionToken = prefix + "_ARBITER_BODY_SPECIAL_SHOCKWAVE_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterSpecialIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.ChannelShockwave)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 5,
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(RiskOfRuinaPlugin.developerPrefix + "_ARBITER_BODY_DEFAULT_SKIN_NAME",
                Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterMainSkin"),
                defaultRenderers,
                mainRenderer,
                model);
            ...
            defaultSkin.meshReplacements = new SkinDef.MeshReplacement[]
            {
                ...
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshArbiter"),
            ...
            secondRendererInfos[0].defaultMaterial = Assets.CreateMaterial("matSkinTwo", 0.8f, new Color(255f / 255f, 255f / 106f, 0f));

            SkinDef secondSkin = Modules.Skins.CreateSkinDef(RiskOfRuinaPlugin.developerPrefix + "_ARBITER_BODY_SECOND_SKIN_NAME",
                Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterSecondSkin"),
                secondRendererInfos,
                mainRenderer,
                model);
            ...
            #region ThirdSkin
            CharacterModel.RendererInfo[] thirdRendererInfos = new CharacterModel.RendererInfo[defaultRenderers.Length];
            defaultRenderers.CopyTo(thirdRendererInfos, 0);

            thirdRendererInfos[0].defaultMaterial = Assets.CreateMaterial("matSkinThree", 0.8f, new Color(255f / 82f, 255f / 82f, 255f / 82f));
            
            SkinDef thirdSkin = Modules.Skins.CreateSkinDef(RiskOfRuinaPlugin.developerPrefix + "_ARBITER_BODY_THIRD_SKIN_NAME",
                Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterThirdSkin"),
                thirdRendererInfos,
                mainRenderer,
                model);
            
            thirdSkin.meshReplacements = new SkinDef.MeshReplacement[]
            {
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshArbiter"),
            ...
            #region MasterySkin
            CharacterModel.RendererInfo[] fourthRendererInfos = new CharacterModel.RendererInfo[defaultRenderers.Length];
            defaultRenderers.CopyTo(fourthRendererInfos, 0);

            fourthRendererInfos[0].defaultMaterial = Assets.CreateMaterial("matArbiterMastery", 1f, Color.yellow, 1.0f);

            SkinDef masterySkin = Modules.Skins.CreateSkinDef(RiskOfRuinaPlugin.developerPrefix + "_ARBITER_BODY_MASTERY_SKIN_NAME",
                Assets.mainAssetBundle.LoadAsset<Sprite>("texArbiterMasterySkin"),
                fourthRendererInfos,
                mainRenderer,
                model,
            ...
            masterySkin.meshReplacements = new SkinDef.MeshReplacement[]
            {
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshArbiterMastery"),
