...
namespace RiskOfRuinaMod.Modules.Survivors
{
    internal class BlackSilence : SurvivorBase
    {
        ...
        internal override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            bodyNameToken = RiskOfRuinaPlugin.developerPrefix + "_BLACKSILENCE_BODY_NAME",
            bodyColor = Color.red,
            ...
            jumpCount = 2,
            maxHealth = 110f,
            subtitleNameToken = RiskOfRuinaPlugin.developerPrefix + "_BLACKSILENCE_BODY_SUBTITLE",
