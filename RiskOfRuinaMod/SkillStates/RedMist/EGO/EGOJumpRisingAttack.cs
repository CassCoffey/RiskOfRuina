...
{
    class EGOJumpRisingAttack : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            this.swingEffectPrefab = Modules.Assets.EGOSwordSwingEffect;
        ...
        {
            base.PlayCrossfade("FullBody, Override", "EGOJumpSlashContinue", "BaseAttack.playbackRate", this.duration, 0.1f);
        }
