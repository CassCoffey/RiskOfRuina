...
{
    class ForwardAttack : BaseStates.BaseDirectionalSkill
    {
        public override void OnEnter()
        {
            ...
            this.impactSound = Modules.Assets.swordHitSoundStab.index;
            switch (attackIndex)
            {
                case (1):
            ...
            this.swingEffectPrefab = statTracker.piercePrefab;
        }
        ...
        protected override void PlayAttackAnimation()
        {
            if (this.attackIndex >= 2)
            {
                base.PlayCrossfade("FullBody, Override", "ForwardSpear" + this.attackIndex, "BaseAttack.playbackRate", this.duration, 0.01f);
            } else
            {
                base.PlayCrossfade("FullBody, Override", "ForwardSpear1", "BaseAttack.playbackRate", this.duration, 0.1f);
            }
        }
