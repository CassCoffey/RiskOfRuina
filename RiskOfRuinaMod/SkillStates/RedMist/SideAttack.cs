...
{
    class SideAttack : BaseStates.BaseDirectionalSkill
    {
        ...
        {
            base.PlayCrossfade("FullBody, Override", "SideSlash" + attackIndex, "BaseAttack.playbackRate", this.duration, 0.1f);
        }
        ...
        public override void FixedUpdate()
        {
            ...
            if (!this.hasFired && !inHitPause)
            {
                ...
                float num = Mathf.Clamp(0f, 2.5f, 0.5f * trueMoveSpeed);
